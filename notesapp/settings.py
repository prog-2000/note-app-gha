...
# Database
# Use SQLite for CI or when USE_SQLITE env var is set, otherwise use MySQL from env vars.
if os.getenv('USE_SQLITE') == 'true' or os.getenv('CI') == 'true':
    DATABASES = {
        'default': {
    ...
    # Production / local configuration using environment variables (MySQL)
    DATABASES = {
        'default': {
